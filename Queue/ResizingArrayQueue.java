...
/**
 * The ResizingArrayQueue class represents a first-in-first-out (FIFO) queue of
 * generic items. This implementation uses a resizing array, which double the
 * underlying array when it is full and halves the underlying array when it is
 * one-quarter full. The enqueue and dequeue operations take constant amortized
 * time. The size, peek, and is-empty operations take constant time in the worst
 * case.
 */
